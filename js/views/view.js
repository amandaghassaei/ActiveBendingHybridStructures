...
function initView(globals){
    ...
    return new (Backbone.View.extend({
        ...
        shouldChangeToMode: function(mode){
            ...
            if (globals.structure.getNumFixed() == 0) return 'You must define at least one fixed node before moving on to simulation and optimization, do this in "Boundaries Editing Mode".';
